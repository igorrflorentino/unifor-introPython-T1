from doc.professor_files.T1.lib import download_dataset
from doc.professor_files.T1.lib import preencher_matriz_contratos
from doc.professor_files.T1.lib import imprimir_matriz
from doc.professor_files.T1.lib import exportar_csv
